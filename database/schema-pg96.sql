-- ============================================================================
-- Perfect Links API - PostgreSQL 9.6 Compatible Schema
-- Version: 2.0.0-pg96
...
-- PostgreSQL 9.6 Compatible: Uses EXECUTE PROCEDURE instead of EXECUTE FUNCTION
-- ============================================================================
...
-- Trigger for users table (PostgreSQL 9.6: EXECUTE PROCEDURE)
CREATE TRIGGER update_users_updated_at
    BEFORE UPDATE ON users
    FOR EACH ROW
    EXECUTE PROCEDURE update_updated_at_column();

-- Trigger for user_usage table (PostgreSQL 9.6: EXECUTE PROCEDURE)
...
-- Trigger to create usage record when user is created (PostgreSQL 9.6: EXECUTE PROCEDURE)
...
-- Trigger to update limit when plan changes (PostgreSQL 9.6: EXECUTE PROCEDURE)
...
-- ============================================================================
-- END OF SCHEMA - PostgreSQL 9.6 Compatible
-- ============================================================================
